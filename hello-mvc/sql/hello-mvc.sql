...
--==========================================
-- web계정 생성
alter session set "_oracle_script" = true; -- c##으로 시작하지 않는 일반 계정 생성 허용
...
update member
set password = 'lJzDQZ2Av1Nk4NC+iO1d0aubxcamjzCNFWXfUF54Gv+oAtYatSnl6MqNHZlIWzzykjtN4epz00abUUG6hG41WA=='
where member_id = 'newnew';