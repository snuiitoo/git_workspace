...
//			request.setCharacterEncoding("utf-8");
			...
			String msg = "회원 정보를 성공적으로 수정했습니다.";
			
			// 세션 정보 갱신 - 바꾼 정보를 바로 보기 위해
			...
			request.getSession().setAttribute("msg", msg); // redirect후에 꺼내서 출력
			response.sendRedirect(request.getContextPath() + "/member/memberView"); // 인덱스가 아닌 회원 수정하는 페이지로 돌아가게
		} catch(Exception e) {
			e.printStackTrace();
			throw e;
		}
