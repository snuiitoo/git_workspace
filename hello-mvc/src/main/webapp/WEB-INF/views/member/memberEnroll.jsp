		...
		<table>
			<tr>
				...
				<td>
					...
					<%-- #idValid 0이면 중복검사 전 1이면 중복검사통과를 의미 --%>
				</td>
			</tr>
			<tr>
				<th>패스워드<sup>*</sup></th>
			...
			<tr>
				<th>휴대폰<sup>*</sup></th>
				<td>	
					<input type="tel" placeholder="(-없이)01012345678" name="phone" id="phone" maxlength="11" value="01045671234" required><br>
				</td>
			</tr>
			<tr>
				<th>주소</th>
...
const checkIdDuplicate = () => {
	...
	const popup = open("", title, spec); // url 비어있는 이유 : 폼 연결, 비어두지 않으면 두번뜸?
 ...
 */
 document.memberEnrollFrm.onsubmit = () => {
	...
	if(!passwordCheck.onblur()){ // 마지막에 제출하기 전에도 검사
		return false; 
	}
